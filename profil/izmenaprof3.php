...
$id = (int) @$_POST['id'];
$lozinka11 = mysqli_real_escape_string($bp, @$_POST['email']);
$lozinkanov = mysqli_real_escape_string($bp, @$_POST['novimail']);
$lozinkanov1 = mysqli_real_escape_string($bp, @$_POST['novimail2']);
